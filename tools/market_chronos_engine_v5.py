...
VALIDATION_MARKER: MARKET_CHRONOS_ENGINE_V5_HTF_LOCATION_DNA
"""
...
def run(args: argparse.Namespace) -> None:
    ...
    write_report(out_root / "chronos_engine_report.md", symbol, anchor_tf, metadata, behavior, dna, contexts, events, level_playbook_best, state_playbook, state_transitions, setup_genome_playbook, htf_location_dna, htf_breakout_alignment)
